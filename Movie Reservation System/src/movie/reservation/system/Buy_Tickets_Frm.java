 ...
 * @author nadinCodeHat
 */
public class Buy_Tickets_Frm extends javax.swing.JFrame {

    public Buy_Tickets_Frm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/movie/reservation/system/images/fast and furious2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buy_Tickets_Frm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buy_Tickets_Frm().setVisible(true);
            }
        });
    }
